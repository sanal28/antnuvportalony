...
namespace NuPortal.NuPortalRequestService {
    ...
    public partial class NuPortalRequestService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public bool CreateRequest(string RequestText, int RequestType, string AttachmentUrl, System.DateTime CompOffFor, System.DateTime RequestedToDate, System.DateTime CreatedDate, int CreatedEmpId, System.DateTime ModifiedDate, int ModifiedEmpId, int Status) {
        ...
        /// <remarks/>
        public void CreateRequestAsync(string RequestText, int RequestType, string AttachmentUrl, System.DateTime CompOffFor, System.DateTime RequestedToDate, System.DateTime CreatedDate, int CreatedEmpId, System.DateTime ModifiedDate, int ModifiedEmpId, int Status) {
            this.CreateRequestAsync(RequestText, RequestType, AttachmentUrl, CompOffFor, RequestedToDate, CreatedDate, CreatedEmpId, ModifiedDate, ModifiedEmpId, Status, null);
        }
        
        /// <remarks/>
        public void CreateRequestAsync(string RequestText, int RequestType, string AttachmentUrl, System.DateTime CompOffFor, System.DateTime RequestedToDate, System.DateTime CreatedDate, int CreatedEmpId, System.DateTime ModifiedDate, int ModifiedEmpId, int Status, object userState) {
        ...
        public bool CancelRequest(int RequestId, int Operation, [System.Xml.Serialization.XmlElementAttribute(IsNullable=true)] System.Nullable<bool> Iscompoff) {
        ...
        /// <remarks/>
        public void CancelRequestAsync(int RequestId, int Operation, System.Nullable<bool> Iscompoff) {
            this.CancelRequestAsync(RequestId, Operation, Iscompoff, null);
        }
        
        /// <remarks/>
        public void CancelRequestAsync(int RequestId, int Operation, System.Nullable<bool> Iscompoff, object userState) {
            ...
            this.InvokeAsync("CancelRequest", new object[] {
                        RequestId,
                        Operation,
                        Iscompoff}, this.CancelRequestOperationCompleted, userState);
        }
        ...
        public bool UpdateRequestStatus(int RequestId, int EmpId, int StatusId, int Operation, [System.Xml.Serialization.XmlElementAttribute(IsNullable=true)] System.Nullable<bool> Iscompoff) {
        ...
        /// <remarks/>
        public void UpdateRequestStatusAsync(int RequestId, int EmpId, int StatusId, int Operation, System.Nullable<bool> Iscompoff) {
            this.UpdateRequestStatusAsync(RequestId, EmpId, StatusId, Operation, Iscompoff, null);
        }
        
        /// <remarks/>
        public void UpdateRequestStatusAsync(int RequestId, int EmpId, int StatusId, int Operation, System.Nullable<bool> Iscompoff, object userState) {
            ...
            this.InvokeAsync("UpdateRequestStatus", new object[] {
                        ...
                        StatusId,
                        Operation,
                        Iscompoff}, this.UpdateRequestStatusOperationCompleted, userState);
        }
